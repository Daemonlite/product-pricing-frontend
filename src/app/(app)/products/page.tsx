...
const ProductsPage: React.FC = () => {
  ...
  const handleProductsInputChange = (
    index: number,
    e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>
  ) => {
    const { name, value } = e.target;
    ...
    <div className="relative">
      ...
      <div className="flex items-center gap-1 overflow-x-auto scroll-smooth py-2 px-1 -mx-1">
        <button
          ...
          className={`flex items-center text-base font-medium cursor-pointer rounded px-6 py-1 transition duration-300 whitespace-nowrap flex-shrink-0 ${
            selectedCategory === "All"
    ...
    <div className="space-y-6">
      ...
      >
        <div className="px-6 py-6">
          {loading ? <Skeleton className="h-10 w-full" /> : categoryFilters}
        </div>
